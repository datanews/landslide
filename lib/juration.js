// A hack of https://github.com/domchristie/juration/blob/master/juration.js
...
(function() {
  ...
  var UNITS = {
    ...
    // '分鐘', '分钟'
    minutes: {
      patterns: ['minute', 'min', 'm(?!s)', 'minutes', 'minuto', 'minutos', '\\u{5206}\\u{9418}', '\\u{5206}\\u{949F}'],
      value: 60,
      formats: {
        'chrono': ':',
        'micro':  'm',
    ...
    // '小時', '鐘頭', '小时', '钟头'
    hours: {
      patterns: ['hour', 'hr', 'h', 'hora', 'horas', '\\u{5C0F}\\u{6642}', '\\u{9418}\\u{982D}', '\\u{5C0F}\\u{65F6}', '\\u{949F}\\u{5934}'],
      value: 3600,
      formats: {
        'chrono': ':',
        'micro':  'h',
